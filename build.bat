...
set "diag_options= /nologo /FC /diagnostics:column /W4 /wd4204 /wd4100 /wd4201 /wd4200 /wd4223 -Wno-microsoft-anon-tag -Wno-logical-op-parentheses"
...
IF "%1"=="debug" (
set "compile_options= /DMM_DEBUG=1 %nocrt_options% %diag_options% /Od /Zo /Z7 -Wno-unused-function"
) ELSE (
